        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="space-y-8">
                    ...
                    <section className="bg-white rounded-lg shadow-sm border p-8">
                        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Event Creation and Management</h2>
                        <div className="space-y-4 text-gray-600">
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-2">Event Organizer Responsibilities</h3>
                    ...
                    <section className="bg-white rounded-lg shadow-sm border p-8">
                        ...
                        <div className="space-y-4 text-gray-600">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-2">Event Responsibility</h3>
