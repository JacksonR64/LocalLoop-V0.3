        ...
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <Card className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900">{metrics.total_events}</p>
                        </div>
                    ...
                    <div className="mt-4 flex items-center text-sm">
                        ...
                        <span className="text-gray-500 ml-2">• {metrics.draft_events} drafts</span>
                    </div>
                </Card>
                ...
                <Card className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900">{metrics.total_attendees}</p>
                        </div>
                ...
                <Card className="p-6">
                    ...
                    <div className="mt-4 flex items-center text-sm">
                        <span className="text-gray-600">From ticket sales</span>
                    </div>
                </Card>
            </div>
